...
public class ReviewService {
    ...
    public Review addReview(Review review) {
        ...
        if (review.getUser() != null) {
            review.setUser(userRepository.findById((Integer) review.getUserId()));
            if (userRepository.findById((Integer) review.getUserId()) == null) {
                new IllegalArgumentException("유효하지 않은 사용자 ID");
            }
        }
